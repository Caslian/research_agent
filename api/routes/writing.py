...
- 符合{request.style}学术写作风格"""
        ...
        # response = await llm.ainvoke("这个报错是为什么，接口在别的agent可以调通：OpenAI API调用失败: Error code: 500 - {'code': 50507, 'message': 'Request processing failed due to an unknown error.', 'data': None}")
